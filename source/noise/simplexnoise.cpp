...
//
// Returned value will be between loBound and hiBound.
double scaled_octave_noise_3d( const double octaves, const double persistence, const double scale, const double loBound, const double hiBound, const double x, const double y, const double z ) {
